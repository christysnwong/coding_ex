...
SELECT category, COUNT(*) FROM analytics GROUP BY category ORDER BY category;
...
SELECT app_name, price, rating, price FROM analytics WHERE rating < 3 ORDER BY price desc LIMIT 1;
